  ...
  return (
    <main className="h-screen overflow-y-auto overflow-x-hidden snap-mandatory snap-y">
      <div className="relative">
        <section className="min-h-screen items-center justify-center flex flex-col snap-start">
          <Hero />
        </section>
        <section className="min-h-screen items-center justify-center flex flex-col snap-start">
          <InView
        ...
        <section className="min-h-[36rem] items-center justify-center flex flex-col footer snap-start">
          <Footer />
        </section>
      </div>
    </main>
